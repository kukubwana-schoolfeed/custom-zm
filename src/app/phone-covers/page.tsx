    ...
    <>
      ...
      <section className="relative min-h-[80vh] flex items-end pb-20 overflow-hidden bg-[#0A0A0A]">
        ...
        <div className="absolute inset-0 z-[0]">
          <Image
            src="/assets/cover/custom-phone-cover-lusaka-zambia-10.webp"
        ...
        <div className="relative z-[3] max-w-7xl mx-auto px-6 pt-24 w-full">
          ...
          <h1 className="headline headline-chrome mb-6" style={{ fontSize: 'clamp(3.5rem, 10vw, 8rem)' }}>
            YOUR PHONE.<br /><span className="text-[var(--steel-bright)]">YOUR IDENTITY.</span>
          </h1>
          ...
          <div className="inline-flex items-center gap-3 mb-8 bg-[#141414] border border-[rgba(157,184,207,0.3)] px-6 py-3">
            <span className="font-display headline headline-chrome text-3xl">K200</span>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {GALLERY_CURATED.map((src, i) => (
              <ScrollReveal key={i} delay={(i % 4) * 0.05}>
                <WrapReveal className="relative aspect-square neon-border group cursor-pointer">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0A]/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                    <span className="text-[var(--steel-bright)] font-semibold text-sm">K200</span>
                  </div>
                </WrapReveal>
              </ScrollReveal>
            ))}
        ...
        <div className="max-w-5xl mx-auto">
          <ScrollReveal>
            ...
            <p className="text-center text-[#888] text-sm mb-12">
              Pick your model below and see it come to life. K200 flat rate — no surprises.
            </p>
          </ScrollReveal>
            ...
            {[
              ...
              <ScrollReveal key={item.title} delay={i * 0.1}>
                <div className="neon-border bg-[#141414] p-8">
                  <h3 className="headline headline-chrome text-xl mb-4">{item.title}</h3>
        ...
        <div className="max-w-3xl mx-auto">
          <ScrollReveal>
            <h2 className="headline headline-chrome mb-6" style={{ fontSize: 'clamp(2.5rem, 7vw, 6rem)' }}>
              K200.<br /><span className="text-[var(--steel-bright)]">YOUR PHONE.</span>
            </h2>
