    ...
    <>
      ...
      <section className="pt-32 pb-16 px-6 bg-[#0A0A0A]">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="headline headline-chrome mb-6" style={{ fontSize: 'clamp(3.5rem, 10vw, 8rem)' }}>
            OUR <span className="text-[var(--steel-bright)]">PORTFOLIO</span>
          </h1>
      ...
      <section className="px-6 pb-4 bg-[#0A0A0A] sticky top-16 z-50">
        <div className="max-w-7xl mx-auto">
          <div className="flex gap-2 overflow-x-auto pb-2 border-b border-[rgba(157,184,207,0.1)]">
            {TABS.map(tab => (
              <button
                key={tab}
                ...
                style={{
                  ...
                  background: active === tab ? 'var(--edge)' : 'transparent',
                  border: `1px solid ${active === tab ? 'var(--edge)' : 'rgba(157,184,207,0.2)'}`,
                }}
              >
                {tab}
              </button>
      ...
      <section className="py-20 px-6 bg-[#111111] text-center">
        <ScrollReveal>
          <h2 className="headline headline-chrome mb-6" style={{ fontSize: 'clamp(2.5rem, 6vw, 5rem)' }}>
            YOUR PIECE.<br /><span className="text-[var(--steel-bright)]">NEXT ON THE WALL.</span>
          </h2>
