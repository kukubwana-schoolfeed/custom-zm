...
const HERO_IMAGES = [
  '/assets/laptop/custom-laptop-wrap-lusaka-zambia-22.webp',
  '/assets/laptop/custom-laptop-wrap-lusaka-zambia-25.webp',
  '/assets/laptop/custom-laptop-wrap-lusaka-zambia-30.webp',
]
      ...
      <section className="relative min-h-[90vh] flex items-end pb-20 overflow-hidden bg-[#0A0A0A]">
        ...
        <div className="relative z-[3] max-w-7xl mx-auto px-6 pt-24">
          ...
          <h1 className="headline headline-chrome mb-6" style={{ fontSize: 'clamp(3.5rem, 10vw, 8rem)' }}>
            YOUR LAPTOP.<br /><span className="text-[var(--steel-bright)]">YOUR RULES.</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {HOW_IT_WORKS.map((step, i) => (
              <ScrollReveal key={step.step} delay={i * 0.15}>
                <div className="relative p-8 bg-[#141414] border border-[rgba(157,184,207,0.1)] hover:border-[rgba(157,184,207,0.4)] transition-all duration-300">
                  <span
                    className="headline headline-chrome block mb-4"
                    style={{ fontSize: '4rem', opacity: 0.3 }}
                  >
                    {step.step}
                  </span>
                  <h3 className="headline headline-chrome text-2xl mb-3">{step.title}</h3>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
            {GALLERY_CURATED.map((src, i) => (
              <ScrollReveal key={i} delay={(i % 4) * 0.05}>
                <WrapReveal className="relative aspect-video neon-border group">
        ...
        <div className="max-w-3xl mx-auto">
          <ScrollReveal>
            <h2 className="headline headline-chrome mb-6" style={{ fontSize: 'clamp(2.5rem, 7vw, 6rem)' }}>
              YOUR SETUP.<br /><span className="text-[var(--steel-bright)]">ELEVATED.</span>
            </h2>
